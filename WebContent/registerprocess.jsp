...
<%@ include file="coockie.jsp"  %>
		...
		<div class="entry">
			This is <strong>City Search </strong>, a free, fully standards site aims to provide information of your city designed by Divy and sandeep.  you can view and post free classified .  we provide scarce information about your city. </div>
...
Connection con=DriverManager.getConnection("jdbc:mysql://localhost:3306/city","root","kaustav11");

String query="insert into rregister(name,password,email,address,country,contact) values(?,?,?,?,?,?)";
